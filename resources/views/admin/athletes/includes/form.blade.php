...
<div class="position-relative form-group">
    ...
    @if(isset($athlete))
        <p>{{'storage/athletes/'.$athlete->athlete_image}}</p>
        <img width="220" src="{{url('storage/athletes/'.$athlete->athlete_image)}}" alt="">
    @endif
...
<div class="position-relative form-group">
    ...
    @if(isset($athlete))
        <img width="220" src="{{url('storage/athletes/'.$athlete->document_image)}}" alt="">
    @endif
...
<div class="position-relative form-group">
    ...
    @if(isset($athlete))
        <img width="220" src="{{url('storage/athletes/'.$athlete->address_image)}}" alt="">
    @endif
...
<div class="position-relative form-group">
    ...
    @if(isset($athlete))
        <img width="220" src="{{url('storage/athletes/'.$athlete->school_image)}}" alt="">
    @endif
